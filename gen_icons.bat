...
convert -size 24x24 xc:yellow -gravity Center \( -density 288 -size 96x96 xc:none -fill 'blue' -font "Consolas"  -pointsize 14  -annotate 0 '1:N' -resize 25% -fuzz 10% -trim \) -composite +repage iconFixedScale.png
